...
class PotsProductSeeder extends Seeder
{
    /**
    ...
    {
        $indibiz = Categorypots::where('nama_category', 'INDIBIZ')->first();
        if (!$indibiz) {
            $indibiz = Categorypots::create(['nama_category' => 'INDIBIZ']);
        }
        ...
        foreach ($products as $product) {
            Productpots::create($product);
        }

        $addon = Categorypots::where('nama_category', 'ADDON')->first();
        if (!$addon) {
            $addon = Categorypots::create(['nama_category' => 'ADDON']);
        }
